...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Diminuir 1 mês: " + diminuirMesInstant);
        System.out.println("Aumentar 7 semanas: " + aumentarSemanaInstant);
        
        /* No caso de datas no formato Instant, vamos utilizar a função minus ou plus, passar o tempo
		 * que desejamos diminuir ou aumentar, seguindo da função ChronoUnit. na qual vamos informar
		 * qual é a unidade cronológica*/
