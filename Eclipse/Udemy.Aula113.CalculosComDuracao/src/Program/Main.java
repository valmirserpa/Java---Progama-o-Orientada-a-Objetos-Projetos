...
public class Main {
    ...
    public static void main(String[] args) {        
        ...
        System.out.println("(LocalDateTime) Calcular duração de tempo utilizando datas com horas:");
        ...
        System.out.println("(Instant) Calcular duração de tempo utilizando datas com horas:");
        ...
        /* Com LocalDateTime e Instant, para calcularmos duração entre datas com horas, precisamos utilizar a classe Duration.
         * A classe Duration não pode ser usada para calcular a diferença entre datas completas (como LocalDate).
         * Ela é mais adequada para calcular diferenças de tempo em termos de horas, minutos, segundos e nanossegundos. */
        
        System.out.println();
        
        System.out.println("(LocalDate) Calcular duração de tempo utilizando datas:");
         ...
         * inserindo a função .atStartOfDay. */
    }
}
