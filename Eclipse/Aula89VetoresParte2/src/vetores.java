...
public class vetores {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < n; i++) { /*Podemos substituir o n por vect.lenght, neste caso irá representar
		//for (int i = 0; i < vect.lenght; i++) automaticamente a quantidade de elementos do vetor*/
			...
			scanner.nextLine();/*
								 ...
								 * depois ter condição de inserir um nextLine
								 */
	...
	//  for (int i = 0; i < vect.lenght; i++)
			sum+=vect[i].getPrice(); // precisamos utilizar o getprice para acessar uma variável private
		}
