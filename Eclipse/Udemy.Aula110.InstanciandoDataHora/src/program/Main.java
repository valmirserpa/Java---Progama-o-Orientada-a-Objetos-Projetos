...
// FORMARTAR DATA A PARTIR DE STRING
		...
		//Outra forma
		LocalDateTime textoDataHora1 = LocalDateTime.parse("27/11/2023 04:50", DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm"));
		System.out.println(textoDataHora1);
		
// FORMATAR DATA COM DIA, MÊS E ANO DE FORMA ISOLADA
		
	LocalDate dataLoca2 = LocalDate.of(2023, 10, 25);
	System.out.println(dataLoca2);
	
	LocalDateTime dataLoca3 = LocalDateTime.of(2023, 10, 25, 04, 50);
	System.out.println(dataLoca3);
